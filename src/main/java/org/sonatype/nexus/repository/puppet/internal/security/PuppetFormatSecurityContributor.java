...
/**
 * Puppet format security resource.
 */
@Named
@Singleton
public class PuppetFormatSecurityContributor
    extends RepositoryFormatSecurityContributor
{
  @Inject
  public PuppetFormatSecurityContributor(@Named(PuppetFormat.NAME) final Format format) {
    super(format);
  }
}
